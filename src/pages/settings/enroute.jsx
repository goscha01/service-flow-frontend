...
const Enroute = () => {
  ...
  return (
    <SettingsRailLayout title="En route" section="Communications" subtitle="Sent when the team is on the way">
                ...
                <div className="bg-white rounded-lg border border-[var(--sf-border-light)] p-6">
                  ...
                  {activeTab === "email" && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-medium text-[var(--sf-text-primary)]">Enable Enroute Email</h3>
                      ...
                      <NotificationTestButton 
                        notificationType="Enroute"
                        messageType="email"
                        templateContent="<h2>We're On Our Way!</h2><p>Hi John,</p><p>Great news! Our team is on the way to your location.</p><p><strong>Service:</strong> Home Cleaning</p><p><strong>Estimated Arrival:</strong> 15 minutes</p><p><strong>Team Member:</strong> Sarah Johnson</p><p>We'll send you another update when we arrive. Thank you for your patience!</p><p>Best regards,<br />The Team at Just web Agency</p>"
                      />
                    </div>
                  )}
                  ...
                  {activeTab === "sms" && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-medium text-[var(--sf-text-primary)]">Enable Enroute SMS</h3>
                          <p className="text-sm text-[var(--sf-text-secondary)] mt-1">
                            Notify your customer with an ETA when you or an employee is on the way.
                          </p>
                        </div>
                      ...
                      <NotificationTestButton 
                        notificationType="Enroute"
                        messageType="sms"
                        templateContent="Hi John! We're on our way to your location. ETA: 15 minutes. See you soon! - Just web Agency"
                      />
                    </div>
                  )}
                </div>
                      ...
                      <div className="border-b border-[var(--sf-border-light)] pb-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="text-[var(--sf-text-primary)]">We're On Our Way!</span>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                              ...
                              <p className="text-[var(--sf-text-primary)]">
                                Great news! Our team is on the way to your location.
                              </p>
                              ...
                              <p className="text-[var(--sf-text-primary)]">
                                We'll send you another update when we arrive. Thank you for your patience!
                              </p>
                              
                              <p className="text-[var(--sf-text-primary)]">Best regards,<br />The Team at Just web Agency</p>
                            </div>
                          </div>
                              ...
                              <div className="space-y-3">
                                <div className="bg-gray-200 rounded-2xl p-3 max-w-xs">
                                  <p className="text-sm text-[var(--sf-text-primary)]">
                                    Hi John! We're on our way to your location. ETA: 15 minutes. See you soon! - Just web Agency
                                  </p>
