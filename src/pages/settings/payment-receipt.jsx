                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2">
                        <input type="checkbox" id="include-details" className="rounded border-gray-300" defaultChecked />
                        <label htmlFor="include-details" className="text-sm text-gray-700">
                          Include service details
                        </label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <input type="checkbox" id="include-payment-method" className="rounded border-gray-300" defaultChecked />
                        <label htmlFor="include-payment-method" className="text-sm text-gray-700">
                          Show payment method
                        </label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <input type="checkbox" id="include-tax-breakdown" className="rounded border-gray-300" defaultChecked />
                        <label htmlFor="include-tax-breakdown" className="text-sm text-gray-700">
                  ...
                  <div className="border-b border-gray-200 pb-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-gray-900">Payment Receipt - Invoice #INV-2025-001</span>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <p className="text-gray-700">
                            Thank you for your payment! This email confirms that we've received your payment for the following service.
                          </p>
                          ...
                          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="text-gray-900">March 10, 2025</span>
                              </div>
                              <div className="flex justify-between">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="text-gray-900">txn_1234567890</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex justify-between font-medium">
                                ...
                                <span className="text-gray-900">$129.90</span>
                              </div>
                            </div>
                          </div>
