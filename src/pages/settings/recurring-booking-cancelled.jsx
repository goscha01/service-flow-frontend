      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-semibold text-gray-900">Recurring Booking Cancelled</h1>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  {activeTab === "email" && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-medium text-gray-900">Enable Recurring Booking Cancelled Email</h3>
                  ...
                  {activeTab === "sms" && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-medium text-gray-900">Enable Recurring Booking Cancelled SMS</h3>
                          <p className="text-sm text-gray-600 mt-1">
                            Sent when a customer's recurring booking is cancelled.
                          </p>
                        </div>
                      ...
                      <div className="border-b border-gray-200 pb-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="text-gray-900">Recurring Booking Cancelled</span>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                                <h3 className="font-medium text-gray-900 mb-2">Cancelled Recurring Service:</h3>
