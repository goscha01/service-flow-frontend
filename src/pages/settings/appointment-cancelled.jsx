      ...
      <div className="flex-1 flex flex-col min-w-0 lg:ml-64 xl:ml-72">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-semibold text-gray-900">Appointment Cancelled</h1>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  {activeTab === "email" && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-medium text-gray-900">Enable Appointment Cancelled Email</h3>
                  ...
                  {activeTab === "sms" && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-medium text-gray-900">Enable Appointment Cancelled SMS</h3>
                          <p className="text-sm text-gray-600 mt-1">
                            Sent if a customer cancels their job. Can also be sent when a job is cancelled from the Serviceflow admin.
                          </p>
                        </div>
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                                <h3 className="font-medium text-gray-900 mb-2">Cancelled Appointment:</h3>
                              ...
                              <p className="text-gray-700">We apologize for any inconvenience.</p>
