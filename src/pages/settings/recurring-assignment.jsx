      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="bg-white border-b border-[var(--sf-border-light)] px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-semibold text-[var(--sf-text-primary)]">Recurring Assignment</h1>
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="bg-white rounded-lg border border-[var(--sf-border-light)] p-8 text-center">
            <h2 className="text-xl font-semibold text-[var(--sf-text-primary)] mb-4">Recurring Assignment Notifications</h2>
