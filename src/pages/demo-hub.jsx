...
const PAGE_GROUPS = [
  {
    ...
    pages: [
      { label: "Dashboard",       path: p("dashboard"),     desc: "Overview of jobs, revenue, and team activity" },
      { label: "Schedule",        path: p("schedule"),      desc: "Daily and weekly job scheduling view" },
      { label: "Calendar",        path: p("calendar"),      desc: "Unified calendar across all team members" },
      { label: "Jobs",            path: p("jobs"),          desc: "All jobs list with filters and search" },
      { label: "Requests",        path: p("request"),       desc: "Incoming booking and quote requests" },
      { label: "Leads Pipeline",  path: p("leads"),         desc: "Kanban pipeline for managing leads" },
      { label: "Notifications",   path: p("notifications"), desc: "System and customer notifications" },
    ],
  },
  {
    id: "finance",
    ...
    pages: [
      { label: "Invoices",  path: p("invoices"),  desc: "All customer invoices and payment status" },
      { label: "Estimates", path: p("estimates"), desc: "Quotes and estimates sent to customers" },
      { label: "Payments",  path: p("payments"),  desc: "Payment records and reconciliation" },
      { label: "Recurring", path: p("recurring"), desc: "Recurring service subscriptions" },
      { label: "Payroll",   path: p("payroll"),   desc: "Team member payroll and earnings" },
    ],
  },
  {
    id: "people",
    ...
    pages: [
      { label: "Customers",         path: p("customers"),        desc: "Customer directory and history" },
      { label: "Team",              path: p("team"),             desc: "Team member list and management" },
      { label: "Team Availability", path: p("team-availability"),desc: "Availability calendar per team member" },
      { label: "Staff Locations",   path: p("staff-locations"),  desc: "Real-time map of staff locations" },
    ],
  },
  {
    id: "business",
    ...
    pages: [
      { label: "Services",       path: p("services"),       desc: "Service catalogue and pricing" },
      { label: "Territories",    path: p("territories"),    desc: "Service area territories" },
      { label: "Coupons",        path: p("coupons"),        desc: "Discount coupons and promo codes" },
      { label: "Online Booking", path: p("online-booking"), desc: "Public booking page settings" },
      { label: "Analytics",      path: p("analytics"),      desc: "Revenue, jobs, and performance charts" },
    ],
  },
  {
    id: "create",
    ...
    pages: [
      { label: "Create Job",        path: p("createjob"),          desc: "Create a new job from scratch" },
      { label: "Bookable Estimate", path: p("bookable-estimate"),  desc: "Create a bookable estimate" },
      { label: "Create Coupon",     path: p("create-coupon"),      desc: "Create a new discount coupon" },
      { label: "Import Data",       path: p("import-data"),        desc: "Import data from CSV or external sources" },
      { label: "Import Customers",  path: p("import-customers"),   desc: "Bulk import customers from CSV" },
      { label: "Import Jobs",       path: p("import-jobs"),        desc: "Bulk import jobs from CSV" },
    ],
  },
  {
    id: "settings",
    ...
    pages: [
      { label: "Settings",           path: p("settings"),                        desc: "Main settings hub" },
      { label: "Account",            path: p("settings-account"),                desc: "Account details and profile" },
      { label: "Billing",            path: p("settings-billing"),                desc: "Subscription and billing info" },
      { label: "Branding",           path: p("settings-branding"),               desc: "Logo, colors, and brand settings" },
      { label: "Availability",       path: p("settings-availability"),           desc: "Business hours and availability" },
      { label: "Payments Settings",  path: p("settings-payments"),               desc: "Payment gateway configuration" },
      { label: "Booking & Quotes",   path: p("settings-booking-quote-requests"), desc: "Booking and quote request rules" },
      { label: "Job Assignment",     path: p("settings-job-assignment"),         desc: "Auto-assignment rules" },
      { label: "Notifications",      path: p("settings-notifications"),          desc: "Email and SMS notification templates" },
      { label: "Calendar Sync",      path: p("settings-calendar-syncing"),       desc: "Google Calendar and iCal sync" },
      { label: "Service Areas",      path: p("settings-service-areas"),          desc: "Zip code and radius service areas" },
      { label: "Field App",          path: p("settings-field-app"),              desc: "Field app settings for team members" },
      { label: "Taxes & Fees",       path: p("settings-taxes-fees"),             desc: "Tax rates and service fees" },
      { label: "Feedback & Reviews", path: p("settings-feedback-reviews"),       desc: "Review request automation" },
      { label: "Developers",         path: p("settings-developers"),             desc: "API keys and webhook settings" },
    ],
  },
  {
    id: "other",
    ...
    pages: [
      { label: "Public Booking", path: "/book/demo",      desc: "Customer-facing booking page (already public)" },
      { label: "Public Quote",   path: "/quote/demo",     desc: "Customer-facing quote request page (already public)" },
      { label: "What's New",     path: p("whats-new"),    desc: "Release notes and changelog" },
      { label: "Help",           path: p("help"),         desc: "Help centre and documentation" },
    ],
  },
]
